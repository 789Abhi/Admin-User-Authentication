...
<nav class="navbar navbar-expand-lg bg-dark ">
  ...
  <form action="{{url('insert-category')}}" method="post" enctype="multipart/form-data">
   ...
   <input type="text" class="form-control border-info" name="gender"required>
   </div>
   <div class="col-md-6 mb-3">
   <label for="">Email</label>
   <input type="email" class="form-control border-info" name="email" required>
   </div>
   <div class="col-md-6 mb-3">
   <label for="">Phone Number</label>
   <input type="tel" name="phone_number"  class="form-control border-info"required>
   </div>
   <div class="col-md-6 mb-3">
   <label for="">Date of Birth</label>
   <input type="date" class="form-control border-info" name="date" required>
   </div>
   <div class="col-md-6 mb-3">
   <label for="">UserName</label>
   <input type="text" class="form-control border-info" name="UserName" required>
   </div>
   <div class="col-md-6 mb-3">
   ...
   <input type="text" class="form-control border-info" name="Address" required>
   </div>
   <div class="col-md-12 mb-3 text-center">
   <label for="" class="text-center">Profile Image </label>
    <input type="file" name="image" class="form-control border-info" required>
   </div>
